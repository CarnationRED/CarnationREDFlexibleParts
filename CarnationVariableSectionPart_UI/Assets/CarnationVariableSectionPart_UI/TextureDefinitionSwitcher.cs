...
namespace CarnationVariableSectionPart.UI
{
    ...
    /// </summary>
    public class TextureDefinitionSwitcher : Switcher<TextureDefinition>, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        protected override string ToString(TextureDefinition s) => s.name;
        protected override void AddItem(TextureDefinition s)
        {
            if (ItemToggles == null) ItemToggles = new Dictionary<TextureDefinition, Toggle>();
